...
-   Let's illustrate the nonparametric regression estimator using simulated data, and compare it to the OLS estimator for a linear model (i.e., $g(x)=\beta_0+\beta_1x$)
